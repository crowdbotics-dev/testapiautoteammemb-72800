...
## Project Structure
    ...
    ├── testapiautoteammemb_72800  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_72800`
...
2. Clone this repo and `cd testapiautoteammemb_72800`
